...
class PageSpeed_Api {
	...
	/**
	 * W3TC Google Client JSON template (no credentials). Set W3TC_GOOGLE_CLIENT_JSON in wp-config.php with your OAuth web client JSON from Google Cloud Console.
	 *
	 * @var string
	 */
	private $google_client_json = '{"web":{"client_id":"","project_id":"","auth_uri":"https://accounts.google.com/o/oauth2/auth","token_uri":"https://oauth2.googleapis.com/token","auth_provider_x509_cert_url":"https://www.googleapis.com/oauth2/v1/certs","client_secret":"","redirect_uris":["google/authorize-in/","google/authorize-out/","google/update-token/","google/get-token/"]}}';
